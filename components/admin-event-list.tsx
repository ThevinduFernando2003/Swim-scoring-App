...
import type { EventStatus, MeetEvent } from "@/lib/types";
...
export function AdminEventList({ events }: { events: MeetEvent[] }) {
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h1 className="text-3xl font-black text-cream">Admin dashboard</h1>
        </div>
